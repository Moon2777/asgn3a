...
function renderAllShapes(){
  ...
  var box3 = new Cube();
  box3.textEnum = 1;
  box3.matrix.translate(-5,-5,-5);
  box3.matrix.scale(10,10,10);
  box3.render();

  var box = new Cube();
  box.textEnum = 0;
  box.matrix.translate(-0.5,-0.5,4);
  box.matrix.rotate(g_beakAngle, 1, 0, 0 );
  //box.matrix.scale(0.5,0.5,0.5);
  //box.matrix.translate(-0.5,-0.5,3);
  box.render();

  var box2 = new Cube();
  box2.textEnum = -2;
  //box2.matrix.scale(0.25,0.25,0.25);
  box2.matrix.translate(-16,-0.5,3);
  box2.matrix.scale(32,0.01,32);
  box2.render();
